...
We used three experiment groups in the final report. First, bring-up tests at 2~m and 10~m line-of-sight verified that the hardware and logging chain worked correctly. Second, long-range obstructed tests at roughly 1 mile compared SF7, SF10, and SF12, including repeats to assess stability. Third, a harder 2-mile obstructed path evaluated whether the same settings remained usable. Short accidental captures were retained in the repository for completeness, but the discussion below emphasizes the longer runs that lasted tens of seconds and therefore better represent sustained link behavior.
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{../results/04_sf_tradeoff/prr_vs_distance.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{../results/04_sf_tradeoff/goodput_vs_airtime.png}
